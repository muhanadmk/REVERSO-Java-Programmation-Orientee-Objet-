...
public class DaoContrat {
    ...
    public static ArrayList<Contrat> findByIdClient(Connection con, Integer idCilent) throws DaoSqlEx {
    ...
    public static ArrayList<Client> findAllCilentQuiOntContrat(Connection con) throws DaoSqlEx, ExceptionMetier {
